  ...
  return (
    <div className="container mx-auto p-5 h-screen">
      ...
      <div className="flex flex-col p-5 mt-5 border-solid border border-grayLighter rounded-lg shadow-md">
        <div className="flex items-center gap-3 border-b border-grayLighter border-solid pb-5">
          <div className="relative w-[124px] h-[106px]">
            <Image src={trip?.coverImage} alt={trip.name} fill style={{backgroundImage: 'cover'}} className="rounded-md"/>
          </div>
      ...
      <div className="flex flex-col mt-5">
          ...
          <div className="flex items-center gap-1">
            <p className="text-primaryDarker font-normal text-sm">{format(startDate, "dd 'de' MMMM ", { locale: ptBR })}</p>
            {' - '}
            <p className="text-primaryDarker font-normal text-sm">{format(endDate, "dd 'de' MMMM ", { locale: ptBR })}</p>
          </div>

          <h3 className="text-primaryDarker font-semibold mt-5">Hóspedes</h3>
          <p className="text-primaryDarker font-normal text-sm">{guests} hóspedes</p>
